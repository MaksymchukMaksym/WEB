...
console.log('angle                 один з двох гострих кутів(коли задана гіпотенуза)');
 ...
 function check_negative(argument_1, type_1, argument_2, type_2){
     //від'ємні аргументи
    if(argument_1 <= 0){
        if(argument_1 == 0){ console.log(type_1+" не може бути рівним 0.");}
        else if (argument_1 < 0){ console.log(type_1+" не може бути меншим 0.");}
        type1=false;}
    
    if(argument_2 <= 0){
        if(argument_2 == 0){console.log(type_2+" не може бути рівним 0.");}
        else if (argument_2 < 0){console.log(type_2+" не може бути меншим 0.");}
        type2=false;}
    }
function check_hypo_leg(argument_1, type_1, argument_2, type_2){
    ...
    if(type_1=="leg"&&type_2=="hypotenuse"){
        if(argument_1>argument_2){console.log(type_1+" більший за "+ type_2); type1=false;}
        else if(argument_1==argument_2){ console.log(type_1+" рівний "+ type_2); type1=false;}
        }

    if(type_1=="hypotenuse"&&type_2=="leg"){
        if(argument_2>argument_1){console.log(type_2+" більший за "+ type_1);type2=false;}
        else if(argument_1==argument_2){console.log(type_1+" рівний "+ type_2);type2=false;}
        }
}
...
function check_blunt_angle(argument_1, type_1, argument_2, type_2){
       ...
       if(type_1=="adjacent angle"){
        if(argument_1>89){ console.log(type_1+" є негострим кутом");
        type1=false;}
       }
       if(type_2=="adjacent angle"){
        if(argument_2>89){ console.log(type_2+" є негострим кутом");
        type2=false;}
       }
...
// помилка в парі параметрів або назві параметра
    ...
    if(type_1 == "leg" && type_2 == "leg") {
        ...
        if(type1){a = argument_1;}
        if(type2){b = argument_2;}
        if(!type1){console.log("Використовується значення за замовчуванням a = "+a);}
        if(!type2){console.log("Використовується значення за замовчуванням b = "+b);}
        ...
        check_negative(argument_1, type_1, argument_2, type_2);
    if(type1){a = argument_1;}
    if(type2){c = argument_2;}

        check_hypo_leg(a, type_1, c, type_2);
        if(a>c){c = 10.3;}
    if(type1&&type2){a=argument_1;c=argument_2;}
    else{console.log("Використовується значення за замовчуванням a = "+a+" c = "+c);}
    ...
    beta = Math.acos(a/c)*180/Math.PI;
        ...
        if(type2){ alpha=argument_2;}
        else{console.log("Використовується значення за замовчуванням alpha = "+alpha);}
        ...
        if(!type1){console.log("Використовується значення за замовчуванням a = "+a);}
        check_blunt_angle(argument_1, type_1, argument_2, type_2);
        if(type2){ beta=argument_2;}
        else{console.log("Використовується значення за замовчуванням beta = "+beta);}
        ...
        check_negative(argument_1, type_1, argument_2, type_2);
        if(type1){c = argument_1;}
        if(!type1){console.log("c<0 використовується значення за замовчуванням c = "+c);}
        check_blunt_angle(argument_1, type_1, argument_2, type_2);
        if(type2){ alpha=argument_2;}
        else{console.log("Використовується значення за замовчуванням alpha = "+alpha);}
...
////////// з оберненим порядком аргументів
    ...
    check_negative(argument_1, type_1, argument_2, type_2);
    if(type1){c = argument_1;}
    if(type2){a = argument_2;}

        check_hypo_leg(c, type_1, a, type_2);
        if(a>c){c = 10.3;}
    if(type1&&type2){c=argument_1;a=argument_2;}
    else{console.log("Використовується значення за замовчуванням a = "+a+" c = "+c);}
    b=Math.sqrt(Math.pow(c,2)-Math.pow(a,2));
    alpha = Math.asin(a/c)*180/Math.PI;
    beta = Math.acos(a/c)*180/Math.PI;
            ...
            check_negative(argument_1, type_1, argument_2, type_2);
            if(type2){a = argument_2;}
            if(!type2){console.log("Використовується значення за замовчуванням a = "+a);}
            check_blunt_angle(argument_1, type_1, argument_2, type_2);
            if(type1){alpha=argument_1;}
            else{console.log("Використовується значення за замовчуванням alpha = "+alpha);}
            c=a / (Math.sin(alpha * Math.PI/180));
            b=Math.sqrt(Math.pow(c,2)-Math.pow(a,2));
            beta = 90 - alpha;
            ...
            check_negative(argument_1, type_1, argument_2, type_2);
            if(type2){a = argument_1;}
            if(!type2){console.log("Використовується значення за замовчуванням a = "+a);}
            check_blunt_angle(argument_1, type_1, argument_2, type_2);
            if(type1){ beta=argument_2;}
            else{console.log("Використовується значення за замовчуванням beta = "+beta);}
            c = a / (Math.cos(beta * Math.PI/180));
            b = Math.sqrt(Math.pow(c, 2) - Math.pow(a, 2));
            alpha = 90 - beta;
            ...
            check_negative(argument_1, type_1, argument_2, type_2);
            if(type2){c = argument_2;}
            if(!type2){console.log("c<0 використовується значення за замовчуванням c = "+c);}
            check_blunt_angle(argument_1, type_1, argument_2, type_2);
            if(type1){ alpha=argument_1;}
            else{console.log("Використовується значення за замовчуванням alpha = "+alpha);}
       /* alpha=argument_1;
